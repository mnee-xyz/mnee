...
async function testPagination() {
  ...
  if (page1.length > 0 && page2.length > 0) {
    ...
    console.log('    Page 1 outpoints:', page1Outpoints.map(op => op.substring(0, 20) + '...'));
    console.log('    Page 2 outpoints:', page2Outpoints.map(op => op.substring(0, 20) + '...'));
    if (page3.length > 0) {
      console.log('    Page 3 outpoints:', page3Outpoints.map(op => op.substring(0, 20) + '...'));
    }
    ...
    if (duplicates12.length > 0) {
      ...
      console.log('    Duplicate outpoints:', duplicates12.map(op => op.substring(0, 30) + '...'));
