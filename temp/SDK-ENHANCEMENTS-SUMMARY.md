...
_Note: The sandbox URL configuration mentioned in your feedback was addressed in an earlier release._
...
- `parseCosignerScripts(scripts: Script[])` - Extract addresses from cosigner scripts
